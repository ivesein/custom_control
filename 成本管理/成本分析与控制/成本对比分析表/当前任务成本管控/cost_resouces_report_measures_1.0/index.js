;(function(KDApi, $) {
  ...
  MyComponent.prototype = {
      ...
      _setModel: function(model) {
        ...
        this.model.costResourcesRMVue = null
      },
      init: function(props) {
      ...
      update: function(props) {
        ...
        console.log(this.model.costResourcesRMVue)
        if (this.model.costResourcesRMVue) {
          this.model.costResourcesRMVue.handleUpdata(this.model, props)
        }
      },
      destoryed: function() {
              ...
              KDApi.loadFile(
                ...
                function() {
                  KDApi.templateFilePath(
                    ...
                    model.costResourcesRMVue = new Vue({
                      delimiters: ["${", "}"],
                      data: {
                    ...
                    }).$mount($("#costResoucesRMApp", model.dom).get(0))
                  })
                }
              )
            })
  ...
  // 注册自定义控件
  KDApi.register("cost_resources_rm_v1.0", MyComponent)
})(window.KDApi, jQuery)