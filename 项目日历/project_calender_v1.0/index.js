...
(function(KDApi, $) {
  ...
  MyComponent.prototype = {
      ...
      _setModel: function(model) {
        ...
        this.model.projectCalendarVue = null
      },
      init: function(props) {
      ...
      update: function(props) {
        ...
        if (this.model.projectCalendarVue && props.data) {
          this.model.projectCalendarVue.handleUpdata(this.model, props)
        } else {
          setHtml(this.model, props)
        }
      },
  ...
  var setHtml = function(model, props) {
      KDApi.loadFile("./css/element.css", model.schemaId, function() {
        KDApi.loadFile("./css/main.css", model.schemaId, function() {
          KDApi.loadFile("./js/time.js", model.schemaId, function() {
            KDApi.loadFile("./js/lodash.js", model.schemaId, function() {
              KDApi.loadFile("./js/nongli.js", model.schemaId, function() {
                        ...
                        function() {
                          KDApi.templateFilePath(
                            ...
                            model.dom.innerHTML = result
                              ...
                              // 	return
                              // }
                            model.projectCalendarVue = new Vue({
                              delimiters: ["${", "}"],
                              data: {
                              ...
                              created() {
                                ...
                                this.renderDate = this.handleCalendarData(this.projectCalendarData.calendarData, {
                                  exceptionId: 'uuid', // 数据库中取出的例外的主键,新增的没有
                                  exceptionName: '月例外', // 例外名称
                                  ...
                                  switch (row.cycleType) {
                                    ...
                                    case "1":
                                      ...
                                      row.weekChecks.forEach(function(v) {
                                        this.weekChecked.push(Number(v))
                                      })
                                      break;
                                    case "2":
                            ...
                            }).$mount($("#projectCalenderApp", model.dom).get(0))
                          })
                        }
                      )
                    }
    ...
    // 注册自定义控件
  KDApi.register("project_calendar_v1.0", MyComponent)
})(window.KDApi, jQuery)