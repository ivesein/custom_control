      ...
      KDApi.loadFile("./css/main.css", model.schemaId, function () {
        KDApi.loadFile("./js/vue.min.js", model.schemaId, function () {
          KDApi.loadFile("./js/echarts.min.js", model.schemaId, function () {
            KDApi.loadFile("./js/macarons.js", model.schemaId, function () {
                    ...
                    methods: {
                      handleUpdata(model, props) {
                        if (props.data !== undefined) {
                          ...
                          this.summaryData[1].value =
                            props.data.incomeCountMap.incomeSum;
                          this.summaryData[2].value =
                            props.data.service.serviceSum;

                          this.summaryData[0].resTitle =
                            this.summaryData[0].title +
                            "：" +
                            this.summaryData[0].value;
                          this.summaryData[1].resTitle =
                            this.summaryData[1].title +
                            "：" +
                            this.summaryData[1].value +
                            "元";
                          this.summaryData[2].resTitle =
                            this.summaryData[2].title +
                            "：" +
                            this.summaryData[2].value +
                            "次";
                          ...
                          this.optionOne.series[0].data = pieDataDefault;
                          //处理折线图默认数据
                          let lineXDataDefault = [
                            "1月",
                            "2月",
                            "3月",
                            "4月",
                          ...
                          let lineMarkDataDefault = []; //处理标记显示
                          this.optionTwo.xAxis.data = lineXDataDefault;
                          this.optionTwo.series[0].data = lineDataDefault;
                          this.optionTwo.series[0].markPoint.data = lineMarkDataDefault;
                          ...
                          let barDataDefault = [0, 0, 0, 0, 0]; //处理y轴数据
                          let barMarkDataDefault = []; //处理标记显示
                          this.optionThree.xAxis[0].data = barXDataDefault;
                          this.optionThree.series[0].data = barDataDefault;
                          this.optionThree.series[0].markPoint.data = barMarkDataDefault;
                          ...
                          let radarData = [100, 100, 100, 100, 100];
                          this.optionFive.radar.indicator = indicatorData;
                          this.optionFive.series[0].data = [
                            {
                              value: radarData,
