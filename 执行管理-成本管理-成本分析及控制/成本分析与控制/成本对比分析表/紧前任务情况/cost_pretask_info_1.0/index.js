; (function (KDApi, $) {
                    ...
                    methods: {
                      handleUpdata(model, props) {
                        if (props.data !== undefined) {
                          ...
                          }else if(props.data.method === 'getClickedTaskDetailData'){
                            this.beforeTaskInfo.data=props.data.data.beforeTaskInfo||[]
                            this.currentTaskInfo.data=props.data.data.currentTaskInfo||[]
                            this.earnedValueAnalysisSuggestions.data=props.data.data.earnedValueAnalysisSuggestions||[]
                            this.followTaskProcessing.data=props.data.data.followTaskProcessing||[]
                          }else{
  ...
  // 注册自定义控件
  KDApi.register("cost_pretask_info_v1.0", MyComponent)
})(window.KDApi, jQuery)