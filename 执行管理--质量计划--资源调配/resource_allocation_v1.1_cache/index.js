                    ...
                    model.resourceAllocationVue = new Vue({
                      ...
                      mounted() {
                        ...
                        this.$nextTick(function () {
                          ...
                          if (_this.$refs.resourceAllocationTable.$el !== undefined) {
                            _this.tableHeight = height - _this.$refs.resourceAllocationTable.$el.offsetTop - 80
                          } else {
                            // 处理偶发性初始化加载不出来的bug
                            setHtml(model, props)
                          }
                          ...
                          if (ids.selected.length === 0) {
                            ...
                            if (ids.idArr.length === 0) {
                              ...
                              if (ids.idArr[0].subArray[0].owner_role === "" || ids.idArr[0].subArray[0].owner_role === null || ids.idArr[0].subArray[0].owner_role === undefined) {
                                raChangedIds = raChangedIds.concat(this.currentSelectedIds)
                                model.invoke(
                                  "setQualityPlanRole",
                                  sendData
                                )
