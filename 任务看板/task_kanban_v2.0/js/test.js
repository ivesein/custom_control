...
new Vue({
  ...
  methods: {
    ...
    handleSummaryTZItemClicked: function handleSummaryTZItemClicked(item) {
    ...
    handleCurrentTypeTaskDisplay: function handleCurrentTypeTaskDisplay(type) {
      var _this = this;
    ...
    handleSummaryItemClicked: function handleSummaryItemClicked(item) {
      ...
      console.log("item>>>", item); // console.log("info>>>", info)
    },
    handleTaskNameClicked: function handleTaskNameClicked(item) {
      console.log(item);
    },
    handleTZTaskNameClicked: function handleTZTaskNameClicked(item) {
      console.log(item);
      model.invoke("taskNameClick", item.taskid);
    },
    tzClickAccept: function tzClickAccept(item) {
      console.log(item);
      model.invoke("taskAccept", item.taskid);
    },
    designClickAccept: function designClickAccept(item) {
      var _this2 = this;
    ...
    auditUrge: function auditUrge(item) {
      var _this3 = this;
    ...
    reviewUrge: function reviewUrge(item) {
      var _this4 = this;
    ...
    iconArrowClick: function iconArrowClick(item) {
      item.open = !item.open;
    },
    auditClickAccept: function auditClickAccept(row) {
      console.log(row);
    },
    reviewClickAccept: function reviewClickAccept(item) {
      var _this5 = this;
