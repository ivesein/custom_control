  ...
  var setHtml = function (model, props) {
    KDApi.loadFile("./css/element.css", model.schemaId, function () {
      KDApi.loadFile("./css/main.css", model.schemaId, function () {
        // KDApi.loadFile("./js/cycle.js", model.schemaId, function () {
                              ...
                              KDApi.templateFilePath(
                                ...
                                model.netPicAppVue = new Vue({
                                  ...
                                  methods: {
                                    ...
                                    cacheLayoutData(pId, itemKey, jsonStr) {
                                      if (pId === "") return;
                                      localStorage.setItem(
                                        "plan-nt-" + itemKey + "-" + pId,
                                        jsonStr
                                    ...
                                    getCachedLayoutData(pId, itemKey) {
                                      if (pId === "") return;
                                      let data = localStorage.getItem(
                                        "plan-nt-" + itemKey + "-" + pId
                                      );
                                      return JSON.retrocycle(JSON.parse(data));
                                    },
                                    handleCacheData(projectId) {
                                      ...
                                      let myInterval = setInterval(() => {
                                        ...
                                        if (ntCachedData !== null) {
                                          ...
                                          //   // );
                                          //   let aoan = this.getCachedLayoutData(
                                          //     this.projectId,
                                          //     "aoan"
                                          //   );
                                          //   let layoutData = {
                                          //     nodeCoordinate: this.getCachedLayoutData(
                                          //       this.projectId,
                                          //       "nodeCoordinate"
                                          //     ),
                                          //     edges: this.getCachedLayoutData(
                                          //       this.projectId,
                                          //       "edges"
                                          //     ),
                                          //     option: this.getCachedLayoutData(
                                          //       this.projectId,
                                          //       "option"
                                          //     ),
                                          //   };
