              ...
              KDApi.loadFile("./js/element.js", model.schemaId, function () {
                KDApi.templateFilePath(
                  ...
                  model.resourceLoadChartsApp = new Vue({
                    ...
                    mounted() {
                      //   this.ifChartShow =
                      //     displayWhichOne === "chartOne" ? true : false;
                        ...
                        if (props.data) {
                          ...
                          switch (displayWhichOne) {
                            case "chartOne": //chartOne 资源利用率
                              resourceLoadChartOption2.xAxis.data =
                                props.data.xAxisData;
                              resourceLoadChartOption2.legend.data = [];
                              resourceLoadChartOption2.series = [];
                              resourceLoadChartOption2.yAxis.name =
                                props.data.workTimeUnit;
                              ...
                              resourceLoadChartOption2.tooltip.formatter = function (
                                params
                              ) {
                                // console.log(params)
                            ...
                            case "chartTwo": //chartTwo 资源可用
                              resourceLoadChartOption1.xAxis.data =
                                props.data.xAxisData;
                              resourceLoadChartOption1.legend.data = [];
                              resourceLoadChartOption1.series = [];
                              resourceLoadChartOption1.yAxis.name =
                                props.data.workTimeUnit;
                              props.data.resourceData.forEach(function (v, k) {
                              ...
                              resourceLoadChartOption1.tooltip.formatter = function (
                                params
                              ) {
                                // console.log(params)
                                let date = params[0].name;
                  ...
                  }).$mount($("#resourceLoadChartsApp", model.dom).get(0));
                });
              });
            });
          });
